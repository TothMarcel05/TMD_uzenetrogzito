        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                while (choice)
                {
                    ...
                    catch { Console.Clear(); Console.WriteLine("Nem számot adott meg!"); choice = true; continue;  }
                    Console.Clear();
                ...
                {
                    Console.Clear();
                    Console.Write($"Itt vannak a felvett adatai, ilyen formátumba lesznek továbbítva:\n{sernum + 1};{name};{message};{phnum};{DateTime.Now}\nMegfelel?(I/N): ");
                    ...
                    Console.Write("Szeretné folytatni?(I/N): ");
                    char exit = char.Parse(Console.ReadLine().ToUpper());
                    if (exit == 'N') Environment.Exit(0);
                    else if (exit == 'I')
                    {
                        Console.Clear();
                        continue;
